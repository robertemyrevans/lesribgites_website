window.onload = function () {
    ...
    sendBtnElem.addEventListener("click", function () {
        ...
        if (message != null && message != "") {
            ...
            sendChatGPTMessage("In the no-nonsense style of a science professor, with direct unabiguous clarity, and a list of itemised actions: " + message, generateAIChatBubble);
